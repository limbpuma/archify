...
const MESSAGE_PAIRS = {
  ...
  'diagram.description.flowchart': ['A program flowchart (DIN 66001 / ISO 5807) generated by Archify.', '由 Archify 生成的程序流程图（DIN 66001 / ISO 5807）。'],
  'node.context.flowchart': ['Flowchart symbol', '流程图符号'],
  'legend.flowchart.terminator': ['start / end', '开始 / 结束'],
  'legend.flowchart.process': ['process', '处理'],
  'legend.flowchart.decision': ['decision', '判断'],
  'legend.flowchart.io': ['input / output', '输入 / 输出'],
  'legend.flowchart.subroutine': ['subroutine / call', '子程序 / 调用'],
  'legend.flowchart.connector': ['connector', '连接点'],
  'diagram.description.struktogramm': ['A Nassi-Shneiderman diagram (Struktogramm, DIN 66261) generated by Archify.', '由 Archify 生成的 Nassi-Shneiderman 结构图（DIN 66261）。'],
  'node.context.struktogramm': ['Struktogramm block', '结构图块'],
  'legend.struktogramm.statement': ['statement', '语句'],
  'legend.struktogramm.io': ['input / output', '输入 / 输出'],
  'legend.struktogramm.call': ['subroutine call', '子程序调用'],
  'legend.struktogramm.branch': ['branch / case', '分支 / 多选'],
  'legend.struktogramm.loop': ['loop', '循环'],
  'legend.struktogramm.exit': ['exit', '退出'],
  'diagram.description.uml-class': ['A UML class diagram (Klassendiagramm) generated by Archify.', '由 Archify 生成的 UML 类图。'],
  'node.context.uml-class': ['UML classifier', 'UML 分类器'],
  'legend.uml-class.class': ['class', '类'],
  'legend.uml-class.abstract': ['abstract class', '抽象类'],
  'legend.uml-class.interface': ['interface', '接口'],
  'legend.uml-class.enum': ['enumeration', '枚举'],
  'legend.uml-class.association': ['association', '关联'],
  'legend.uml-class.aggregation': ['aggregation (diamond at the whole)', '聚合（菱形在整体端）'],
  'legend.uml-class.composition': ['composition (filled diamond)', '组合（实心菱形）'],
  'legend.uml-class.inheritance': ['inheritance', '继承 / 泛化'],
  'legend.uml-class.realization': ['realization (implements)', '实现'],
  'legend.uml-class.dependency': ['dependency', '依赖'],
  'diagram.description.erd': ['An entity-relationship diagram generated by Archify.', '由 Archify 生成的实体关系图。'],
  'node.context.erd': ['ER element', 'ER 元素'],
  'legend.erd.entity': ['entity', '实体'],
  'legend.erd.weak-entity': ['weak entity', '弱实体'],
  'legend.erd.relationship': ['relationship', '联系'],
  'legend.erd.attribute': ['attribute', '属性'],
  'legend.erd.key-attribute': ['key attribute (underlined)', '主键属性（下划线）'],
  'legend.erd.derived-attribute': ['derived attribute', '派生属性'],
  'legend.erd.multivalued-attribute': ['multivalued attribute', '多值属性'],
  'legend.erd.one': ['exactly one', '恰好一个'],
  'legend.erd.zero-one': ['zero or one', '零或一'],
  'legend.erd.one-many': ['one or more', '一个或多个'],
  'legend.erd.zero-many': ['zero or more', '零或多个'],
  'legend.erd.many': ['many', '多个'],
  'diagram.description.usecase': ['A UML use case diagram generated by Archify.', '由 Archify 生成的 UML 用例图。'],
  'node.context.usecase': ['Use case element', '用例元素'],
  'usecase.secondary': ['secondary actor', '次要参与者'],
  'legend.usecase.actor': ['actor', '参与者'],
  'legend.usecase.usecase': ['use case', '用例'],
  'legend.usecase.system': ['system boundary', '系统边界'],
  'legend.usecase.association': ['association', '关联'],
  'legend.usecase.include': ['«include»', '«include» 包含'],
  'legend.usecase.extend': ['«extend»', '«extend» 扩展'],
  'legend.usecase.generalization': ['generalization', '泛化'],
  'diagram.description.netzplan': ['An activity-on-node network plan (DIN 69900) generated by Archify.', '由 Archify 生成的节点式网络计划图（DIN 69900）。'],
  'node.context.netzplan': ['Network plan activity', '网络计划活动'],
  'legend.netzplan.activity': ['activity', '活动'],
  'legend.netzplan.critical': ['critical path (GP 0)', '关键路径（总时差 0）'],
  'legend.netzplan.milestone': ['milestone (duration 0)', '里程碑（工期 0）'],
  'diagram.description.activity': ['A UML activity diagram generated by Archify.', '由 Archify 生成的 UML 活动图。'],
  'node.context.activity': ['Activity node', '活动节点'],
  'legend.activity.initial': ['initial node', '初始节点'],
  'legend.activity.final': ['final node', '结束节点'],
  'legend.activity.action': ['action', '动作'],
  'legend.activity.decision': ['decision', '判断'],
  'legend.activity.merge': ['merge', '合并'],
  'legend.activity.fork': ['fork', '分叉'],
  'legend.activity.join': ['join', '汇合'],
  'legend.activity.object': ['object node', '对象节点'],
  'legend.activity.lane': ['swimlane', '泳道'],
  'diagram.description.epk': ['An event-driven process chain (eEPK) generated by Archify.', '由 Archify 生成的事件驱动过程链（eEPK）。'],
  'node.context.epk': ['EPK element', 'EPK 元素'],
  'legend.epk.event': ['event', '事件'],
  'legend.epk.function': ['function', '功能'],
  'legend.epk.xor': ['XOR connector', 'XOR 连接器'],
  'legend.epk.and': ['AND connector (∧)', 'AND 连接器（∧）'],
  'legend.epk.or': ['OR connector (∨)', 'OR 连接器（∨）'],
  'legend.epk.org': ['organisational unit', '组织单元'],
  'legend.epk.info': ['information object', '信息对象'],
