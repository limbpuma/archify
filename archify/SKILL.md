...
1. Choose `architecture`, `workflow`, `sequence`, `dataflow`, `lifecycle`, `flowchart`, `struktogramm`, `uml-class`, `erd`, or `epk` from the question.
