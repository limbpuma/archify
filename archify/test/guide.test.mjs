...
test('guide: exposes 15 unique recipes across every diagram type', () => {
  assert.equal(SCENARIO_RECIPES.length, 15);
  assert.equal(new Set(SCENARIO_RECIPES.map((recipe) => recipe.id)).size, 15);
  assert.deepEqual(
