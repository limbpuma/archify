...
test('guide: exposes 20 unique recipes across every diagram type', () => {
  assert.equal(SCENARIO_RECIPES.length, 20);
  assert.equal(new Set(SCENARIO_RECIPES.map((recipe) => recipe.id)).size, 20);
  assert.deepEqual(
